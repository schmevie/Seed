...
module.exports = function(app, passport) {
	...
	app.get('/map', function(req, res) {
		res.render('mapView.ejs', { message: 'hiii' });
	});
	app.get('/profilePage', function(req, res) {
		res.render('../views/profilePage.ejs', { message: 'hiii' });
	});
	// =====================================
	// LOGIN ===============================
	// =====================================
	...
	app.get('/login', function(req, res) {
		...
		res.render('../views/signUp.ejs', { message: req.flash('loginMessage') });
		// res.render('login.ejs', { message: req.flash('loginMessage') });
	});

	// process the login form
	app.post('/login', passport.authenticate('local-login', {
		successRedirect : '/marketplace', // redirect to the secure marketplace section
	...
	app.get('/signup', function(req, res) {
		...
		// render the page and pass in any flash data if it exists
		res.render('../views/RegistrationPage.ejs', { message: req.flash('signupMessage') });
		//signup
	...
	app.get('/marketplace', isLoggedIn, function(req, res) {
		res.render('../views/marketplace.ejs', {
